...
LIBRARY_DEPENDENCIES="boost cryptopp gmp leveldb miniupnpc secp256"
...
exportConfig() {
  ...
  CXXFLAGS="-arch $IOS_ARCH -fPIC -g -Os -pipe --sysroot=$IOS_SYSROOT -I$INCLUDE_DIR -I$CRYPTOPP_DIR -std=gnu++11 -stdlib=libc++ -Wno-constexpr-not-const"
